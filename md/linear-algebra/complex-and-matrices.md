...
## Блок 6.
Найдите такие матрицы $A_{3\times1}$ и $B_{1\times 3}$, что $A \cdot B = C$. 
...
8.1. $\begin{vmatrix}1 & \varepsilon & \varepsilon^2\\ \varepsilon^2 & 1 & \varepsilon\\ \varepsilon & \varepsilon^2 & 1\end{vmatrix}$, где $\varepsilon = -\frac{1}{2} + i\frac{\sqrt{3}}{2}$

8.2. $\begin{vmatrix}1 & 1 & \varepsilon^2\\1 & 1 & \varepsilon\\\varepsilon^2 & \varepsilon & 1\end{vmatrix}$, где $\varepsilon = \cos \frac{2\pi}{3} + i\sin\frac{2\pi}{3}$

8.3. $\begin{vmatrix}1 & 1 & 1\\1 & \varepsilon & \varepsilon^2\\1 & \varepsilon^2 & \varepsilon\end{vmatrix}$, где $\varepsilon = \cos\frac{4\pi}{3} + i\sin\frac{4\pi}{3}$

8.4. $\begin{vmatrix}1 & 1 & 1\\\varepsilon^2 & 1 & 1\\\varepsilon & \varepsilon^2 & 1\end{vmatrix}$, где $\varepsilon = \frac{\sqrt{2}}{2} + i\frac{\sqrt{2}}{2}$ 
...
## Блок 10.
Найдите $detA - M_{i,j} + \mathcal{A}_{m,k}$.
