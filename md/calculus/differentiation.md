...
Найдите производную функции в точке $(x_{0},y_{0})=(1,0)$.

3.1. $x = \dfrac{\sqrt{ y+4 }(y-2)^4}{(y+2)^5}$

3.2. $x = -2 \cdot \dfrac{(y-2)^3 \sqrt{ (y+1)^5 }}{(y-4)^2}$

3.3. $\dfrac{2(y+1)^8(y-2)^2}{\sqrt{ (y+4)^3 }}$

3.4. $\dfrac{\sqrt[3]{ (y+1)^7 }(y-2)^4}{(y+4)^2}$

3.5. $\begin{cases}x=(2t+1)\cos t\\y=3t^2-t\end{cases}$

3.6. $\begin{cases}x=\dfrac{2}{t+2}\\y=\left(\dfrac{t}{t+2}\right)^2\end{cases}$

3.7. $\begin{cases}x=e^t \cos t \\ y=e^t\sin t\end{cases}$

3.8. $\begin{cases}x=\dfrac{2 \arcsin t}{\pi}\\y=\sqrt{ 1-t^2 }\end{cases}$

3.9. $(x-y)^2=e^{y(1-x)}$

3.10. $\sin^2\bigg((x-1)^2+(y+1)^2\bigg)=\dfrac{1}{4}$

3.11. $y+1=2e^y+x^2-2x$

3.12. $x(1+2y)=1+\text{tg}xy$

## Блок 4

Для данной функции найдите многочлен Тейлора 2-ого порядка в точке $x_0$: $T_{2}(x)=C_{0}+C_{1}(x-x_{0})+C_{2}(x-x_{0})^2$.

4.1. $y(x)=2x^2-5x+3$, $x_{0}=3$

4.2. $y(x)=-2x^2+3x+7$, $x_{0}=-2$

4.3. $y(x)=5x^2-x+8$, $x_{0}=1$

4.4. $y(x)=x^2+4x-3$, $x_{0}=4$

4.5. $y(x)=\ln(x+3)$, $x_{0}=-1$

4.6. $y(x)=\cos\left( x-\frac{\pi}{6} \right)$, $x_{0}=\frac{\pi}{2}$

4.7. $y(x)=2^{x-1}$, $x_{0}=3$

4.8. $y(x)=\sqrt{ x+2 }$, $x_{0}=2$

## Блок 5

Найдите экстремумы функции.

5.1. $y(x)=\sqrt[3]{ (x^2-3x+2)^2 }$

5.2. $y(x) = x \sqrt[3]{ (x-2)^2 }$

5.3. $y(x)=\sqrt{ \Big|x^2-4\Big| }$

5.4. $y(x)=(x-3)\sqrt{ \Big|x^2-2\Big| }$
